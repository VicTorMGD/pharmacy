...
?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <span>Se requiere del password para continuar...</span>
                    <div class="alert alert-success text-center" id="confirmado" style="display: none;">
                        <span><i class="fas fa-check m-1"> Se modifico al usuario</i></span>
                    </div>
    ...
    <!-- -------End Modal ascender y descender-------- -->
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="alert alert-success text-center" id="add" style="display: none;">
                            <span><i class="fas fa-check m-1"> Se agregó usuario correctamente</i></span>
                        </div>
                        <div class="alert alert-danger text-center" id="noadd" style="display: none;">
                            <span><i class="fas fa-times m-1"> El DNI ya existe en otro usuario</i></span>
                        </div>
                        <form id="form-crear">
                            ...
                            <div class="form-group">
                                ...
                                <input id="edad" type="date" class="form-control" placeholder="Ingrese fecha de nacimiento" require>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input id="pass" type="password" class="form-control" placeholder="Ingrese password" require>
                            </div>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Gestion Usuarios <button id="button-crear" class="btn bg-gradient-primary ml-2" type="button" data-toggle="modal" data-target="#crearusuario">Crear Usuario</button></h1>
                        <input type="" id="tipo_usuario" value="<?php echo $_SESSION['us_tipo'] ?>">
                    </div>
                    <div class="col-sm-6">
        ...
        <section>
            <div class="coniainer-fluid">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div id="usuarios" class="row f-flex align-items-stretch">
